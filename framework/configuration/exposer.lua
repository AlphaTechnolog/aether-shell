...
Configuration = {
    IconsCache = manager:inject_helpers("icons_cache", manager:parse_icons_cache()),
    ...
    GeneralBehavior = manager:inject_helpers("general_behavior", manager:parse_general_behavior()),
}