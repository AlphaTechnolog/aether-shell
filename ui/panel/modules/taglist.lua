    ...
    return awful.widget.taglist({
        ...
        widget_template = {
            ...
            create_callback = function(self, tag)
                local background =
                    self:get_children_by_id("background-element")[1]
                local label_element =
                    self:get_children_by_id("label-element")[1]
                ...
                local colors_anim = animation:new({
                    ...
                    easing = animation.easing.inOutQuad,
                    pos = {
                        background = color.hex_to_rgba(
                            beautiful.colors.background
                        ),
                        foreground = color.hex_to_rgba(
                ...
                function self:update_label()
                    local icons =
                        Configuration.GeneralBehavior:get_key("tag_icons")
                    local num_tags =
                        Configuration.GeneralBehavior:get_key("num_tags")
