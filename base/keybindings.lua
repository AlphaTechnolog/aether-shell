...
-- caution: this file is a mess currently as there're
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "c", function()
		if
			Client.focus and (Client.focus.floating or awful.layout.get(Client.focus.tag) == awful.layout.suit.floating)
		then
