...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey }, "c", function()
        if
            ...
            and (
                ...
                or awful.layout.get(Client.focus.tag)
    ...
    awful.key({ modkey }, "a", function()
        ...
        require("naughty").notify({
            title = "Notification",
            text = "Full notification copied to the clipboard successfully",
        })
    ...
    awful.key(
        ...
        function()
            awful.spawn.easy_async(
                "bash -c 'maim -s | xclip -sel c -t image/png'",
                function()
                    require("naughty").notify({
                        title = "Notification",
                        text = "Ranged notification copied to the clipboard successfully",
                    })
                end
            )
        end,
        {
            description = "Take a screenshot with range (dumb)",
            group = "launcher",
        }
    ),
